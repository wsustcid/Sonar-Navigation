...
@LastEditTime: 2019-08-12 21:43:46
'''
...
class ParallelModelCheckpoint(ModelCheckpoint):
    """ Model checkpoint callback function used for parallel model
    """
...
def trainModel(model, train_generator, train_step,
    ...
    # multi gpu model
    try:
        parallel_model = multi_gpu_model(model, Flags.num_gpu, cpu_relocation=True)
        print("Training using multiple GPUs...")
    except ValueError:
        parallel_model = model
        print("Training using sigle GPU...")
    ...
    #
    model_checkpoint = ParallelModelCheckpoint(model, model_path, 
